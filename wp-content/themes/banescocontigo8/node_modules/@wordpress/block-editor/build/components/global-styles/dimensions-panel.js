...
function DimensionsPanel(_ref4) {
  ...
  const setContentSizeValue = newValue => {
    onChange((0, _object.immutableSet)(value, ['layout', 'contentSize'], newValue));
  };
  ...
  const setWideSizeValue = newValue => {
    onChange((0, _object.immutableSet)(value, ['layout', 'wideSize'], newValue));
  };
  ...
  const setPaddingValues = newPaddingValues => {
    ...
    onChange((0, _object.immutableSet)(value, ['spacing', 'padding'], padding));
  };
  ...
  const setMarginValues = newMarginValues => {
    ...
    onChange((0, _object.immutableSet)(value, ['spacing', 'margin'], margin));
  };
  ...
  const setGapValue = newGapValue => {
    onChange((0, _object.immutableSet)(value, ['spacing', 'blockGap'], newGapValue));
  };
  ...
  const setMinHeightValue = newValue => {
    onChange((0, _object.immutableSet)(value, ['dimensions', 'minHeight'], newValue));
  };
