    ...
    <div class="search-with-filter">
        <div class="container">
            ...
            <div class="search-with-filter__filters">
                ...
                <button class="search-with-filter__filter filter__filter_btn  active" id="btn-ver-todo"
                    data-id="Ver todo">Ver todo</button>
                <?php foreach ($categoryArray as $key => $value) {
                    ?><button class="search-with-filter__filter filter__filter_btn "
                    data-id="<?php echo $value; ?>"><?php echo $value; ?></button><?php
                } ?>
    ...
    <div class="accordions-with-filter">
        <div class="container">
            ...
            <div class="accordions-with-filter__inner" id="filter_container">
                ...
                <div class="accordions-with-filter__left" id="paginated-list" data-current-page="1" aria-live="polite">
                    <?php while( have_rows('accordion_group_1') ): the_row(); ?>
                        ...
                        <div class="accordion-with-filter__header accordion__triger">
                            ...
                            <div class="accordion__icon">
                                <svg width="18" height="12" viewBox="0 0 18 12" fill="none"
                                    ...
                                    <path
                                        d="M1 1.33325L8.24074 9.78079C8.63984 10.2464 9.36016 10.2464 9.75926 9.78079L17 1.33325"
                                        stroke="#708090" stroke-width="2" stroke-linecap="round" />
                                </svg>
