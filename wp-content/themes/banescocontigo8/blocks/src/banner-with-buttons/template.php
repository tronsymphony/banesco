...
<section <?php echo wp_kses_data(get_block_wrapper_attributes()); ?>>
  <div class="banner-with-buttons" style="
    ...
    " data-big-spacing="<?= ($attributes['bigSpacing']) ? "true" : "false" ?>" data-centered="<?= ($attributes['centered']) ? "true" : "false" ?>">
    <div class="container">
...
<script>
  document.querySelectorAll('.banner-with-buttons').forEach(function(wrapper) {
    const currencyBtn = wrapper.querySelector('.button1')

    currencyBtn && currencyBtn.addEventListener('click', function(e) {
      wrapper.querySelector('.banner-with-buttons__hidden').classList.toggle('active')
