        ...
        <div class="compare-cards__inner">
          <div class="compare-cards__table">
            <div class="compare-cards__row compare-cards__row--header">
              ...
              <div class="compare-cards__data">
                <div class="compare-cards__card">
                  ...
                  <div class="compare-cards__card-image">
                    ...
                    <?php else : echo '<img src="'.get_block_url(__DIR__).'/assets/none.png" alt="card2" />'; ?>
                    <?php endif;  ?>
                  </div>
                  ...
                  <?php if (isset($post1)) :   ?>
                    <div class="compare-cards__card-buttons">
                      <a class="compare-cards__card-button primary-button" href="/tarjetas-main/tarjetas-de-credito/">
                        Me interesa
                      </a>
                    </div>
                  <?php else :
              ...
              <div class="compare-cards__data">
                <div class="compare-cards__card">
                  ...
                  <?php if (isset($post2)) :   ?>
                    <div class="compare-cards__card-buttons">
                      <a class="compare-cards__card-button primary-button" href="/tarjetas-de-credito/">
                        Me interesa
                      </a>
                    </div>
                  <?php else :
            ...
            <div class="compare-cards__row">
              <div class="compare-cards__data">
                <img src="<?php the_block_url(__DIR__); ?>/assets/map.svg" alt="map" />
                <?= $attributes['internacional'] ?>
              </div>
              <div class="compare-cards__data">
                <?php if (isset($post1) && get_field('internacional', $post1->ID)) : ?><img src="<?php the_block_url(__DIR__); ?>/assets/check.svg" alt="check" /><?php endif; ?>
              </div>
              <div class="compare-cards__data">
                <?php if (isset($post2) && get_field('internacional', $post2->ID)) : ?><img src="<?php the_block_url(__DIR__); ?>/assets/check.svg" alt="check" /><?php endif; ?>
              </div>
              <div class="compare-cards__data">
                <?php if (isset($post3) && get_field('internacional', $post3->ID)) : ?><img src="<?php the_block_url(__DIR__); ?>/assets/check.svg" alt="check" /><?php endif; ?>
              </div>
            </div>
            <div class="compare-cards__row">
              <div class="compare-cards__data">
                <img src="<?php the_block_url(__DIR__); ?>/assets/nfc.svg" alt="nfc" />
                <?= $attributes['chip'] ?>
              </div>
              <div class="compare-cards__data">
                <?php if (isset($post1) && get_field('chip', $post1->ID)) : ?><img src="<?php the_block_url(__DIR__); ?>/assets/check.svg" alt="check" /><?php endif; ?>
              </div>
              <div class="compare-cards__data">
                <?php if (isset($post2) && get_field('chip', $post2->ID)) : ?><img src="<?php the_block_url(__DIR__); ?>/assets/check.svg" alt="check" /><?php endif; ?>
              </div>
              <div class="compare-cards__data">
                <?php if (isset($post3) && get_field('chip', $post3->ID)) : ?><img src="<?php the_block_url(__DIR__); ?>/assets/check.svg" alt="check" /><?php endif; ?>
              </div>
            </div>
            <div class="compare-cards__row">
              <div class="compare-cards__data">
                <img src="<?php the_block_url(__DIR__); ?>/assets/money.svg" alt="money" />
            ...
            <div class="compare-cards__row">
              <div class="compare-cards__data">
                <img src="<?php the_block_url(__DIR__); ?>/assets/smile.svg" alt="smile" />
                <?= $attributes['puntos_verdes'] ?>
              </div>
              <div class="compare-cards__data">
                <?php if (isset($post1) && get_field('puntos_verdes', $post1->ID)) : ?><img src="<?php the_block_url(__DIR__); ?>/assets/check.svg" alt="check" /><?php endif; ?>
              </div>
              <div class="compare-cards__data">
                <?php if (isset($post2) && get_field('puntos_verdes', $post2->ID)) : ?><img src="<?php the_block_url(__DIR__); ?>/assets/check.svg" alt="check" /><?php endif; ?>
              </div>
              <div class="compare-cards__data">
                <?php if (isset($post3) && get_field('puntos_verdes', $post3->ID)) : ?><img src="<?php the_block_url(__DIR__); ?>/assets/check.svg" alt="check" /><?php endif; ?>
              </div>
            </div>
            <div class="compare-cards__row">
              <div class="compare-cards__data">
                <img src="<?php the_block_url(__DIR__); ?>/assets/secure.svg" alt="secure" />
                <?= $attributes['proteccion_y_seguros'] ?>
              </div>
              <div class="compare-cards__data">
                <?php if (isset($post1) && get_field('proteccion_y_seguros', $post1->ID)) : ?><img src="<?php the_block_url(__DIR__); ?>/assets/check.svg" alt="check" /><?php endif; ?>
              </div>
              <div class="compare-cards__data">
                <?php if (isset($post2) && get_field('proteccion_y_seguros', $post2->ID)) : ?><img src="<?php the_block_url(__DIR__); ?>/assets/check.svg" alt="check" /><?php endif; ?>
              </div>
              <div class="compare-cards__data">
                <?php if (isset($post3) && get_field('proteccion_y_seguros', $post3->ID)) : ?><img src="<?php the_block_url(__DIR__); ?>/assets/check.svg" alt="check" /><?php endif; ?>
              </div>
            </div>
            <div class="compare-cards__row">
              <div class="compare-cards__data">
                <img src="<?php the_block_url(__DIR__); ?>/assets/support.svg" alt="support" />
            ...
            <div class="compare-cards__row">
              <div class="compare-cards__data">
                <img src="<?php the_block_url(__DIR__); ?>/assets/bonus.svg" alt="bonus" />
