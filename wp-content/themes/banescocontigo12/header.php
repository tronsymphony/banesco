				...
				<div class="banner__inner">
					...
					<?php if (get_theme_field('banner_image', true)) : ?>
						<div class="banner__image">
							<img src="<?php the_theme_field('banner_image', get_theme_url() . '/assets/images/banner.png'); ?>" alt="banner">
						</div>
					<?php endif; ?>
						...
						<?php if (get_theme_field('header_logotype', true)) : ?>
							<div class="site-branding lheader__logotype">
								<a class="logotype" href="/">
									<img src="<?php the_theme_field('header_logotype', get_theme_url() . '/assets/images/logotype.png'); ?>" alt="logotype">
								</a>
							</div>
						<?php endif; ?>
						...
						<div class="mheader__inner">
							<div class="site-logo mheader__logo">
								<?php if (get_theme_field('header_logo', true)) : ?>
									<a class="logo" href="/">
										<img src="<?php the_theme_field('header_logo', get_theme_url() . '/assets/images/logo.svg'); ?>" alt="logo">
									</a>
								<?php endif; ?>
							</div>
