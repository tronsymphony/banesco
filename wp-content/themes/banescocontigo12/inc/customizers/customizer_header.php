...
function header_customizer($wp_customize)
{
  ...
  $wp_customize->add_setting('header_locations_button_icon', ['default' => get_theme_url() . '/assets/images/sucursales.svg']);
  ...
  $wp_customize->add_setting('header_logo', ['default' => get_theme_url() . '/assets/images/logo.png']);
  $wp_customize->add_setting('header_logotype', ['default' => get_theme_url() . '/assets/images/logotype.png']);
  ...
  $wp_customize->add_setting('header_primary_button_icon', ['default' => get_theme_url() . '/assets/images/login.svg']);
  ...
  $wp_customize->add_setting('header_outlined_button_icon', ['default' => get_theme_url() . '/assets/images/clients.svg']);
