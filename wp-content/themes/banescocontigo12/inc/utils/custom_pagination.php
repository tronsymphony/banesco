...
function custom_pagination($wp_query, $pages = '', $range = 2)
{
	...
	if (1 != $pages) {
		...
		echo ($paged == 1) ? "<li class='active'><a>1</a></li>" : "<li><a href='" . get_pagenum_link(1) . "'>1</a></li>";
		...
		echo ($paged == $pages) ? "<li class='active'><a>" . $pages . "</a></li>" : "<li><a href='" . get_pagenum_link($pages) . "'>" . $pages . "</a></li>";
