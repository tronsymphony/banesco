...
<section <?php echo wp_kses_data(get_block_wrapper_attributes()); ?>>
  <div class="advantages" style="
    ...
    ">
    <div class="container">
      <?php if ($attributes['advantages']) : ?>
        <div class="advantages__inner">
          <?php foreach ($attributes['advantages'] as $advantage) : ?>
            <a class="advantages__item" href="<?= $advantage['link'] ?>" style="background: <?= $advantage['color'] ?>">
              <div class="advantages__item-image">
                <?php if ($advantage['image']['url'] == '1.svg') : ?>
                  <img src="<?php the_block_url(__DIR__); ?>/assets/1.svg" alt="icon" />
                <?php elseif ($advantage['image']['url'] == '2.svg') : ?>
                  <img src="<?php the_block_url(__DIR__); ?>/assets/2.svg" alt="icon" />
                <?php elseif ($advantage['image']['url'] == '3.svg') : ?>
                  <img src="<?php the_block_url(__DIR__); ?>/assets/3.svg" alt="icon" />
                <?php elseif ($advantage['image']['url'] == '4.svg') : ?>
                  <img src="<?php the_block_url(__DIR__); ?>/assets/4.svg" alt="icon" />
                <?php elseif ($advantage['image']['url'] == '5.svg') : ?>
                  <img src="<?php the_block_url(__DIR__); ?>/assets/5.svg" alt="icon" />
                <?php elseif ($advantage['image']['url'] == '6.svg') : ?>
                  <img src="<?php the_block_url(__DIR__); ?>/assets/6.svg" alt="icon" />
                <?php elseif ($advantage['image']['url'] == '7.svg') : ?>
                  <img src="<?php the_block_url(__DIR__); ?>/assets/7.svg" alt="icon" />
                <?php elseif ($advantage['image']['url']) : ?>
                  <img src="<?= $advantage['image']['url'] ?>" alt="icon" />
                <?php endif; ?>
              </div>
