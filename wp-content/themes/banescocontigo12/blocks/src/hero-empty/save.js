						...
						<div className="hero__content">
							...
							{description && (
								<h3 className="hero__description">
									<span
										className={mDescription ? 'only-desktop' : ''}
						...
						{image.url && (
							<div className="hero__image">
								{image.url == 'banner.png' ? (
									<img className={mImage.url ? 'only-desktop' : ''} src={banner} alt={'banner'} />
								) : image.url ? (
									<img
										className={mImage.url ? 'only-desktop' : ''}
										src={image.url}
										alt={image.alt}
									/>
								) : (
